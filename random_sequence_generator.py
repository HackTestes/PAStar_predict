...
def seq_random_gen(seq_dictionary: [str], current_seq_size: int, seq_size_steps: int, uniques_samples_per_size: int, max_samples: int):
    ...
    for sample_bucket_idx in range( int(max_samples/uniques_samples_per_size) ):
        ...
        while ( current_bucket_uniques_samples < uniques_samples_per_size): # TODO: This logic might need more work
            current_seq = ""
...
seq_random_gen(['A', 'T', 'C', 'G'], 50, 5, 100, 1000)