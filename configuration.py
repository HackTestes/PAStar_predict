...
seq_size_step = 500
unique_samples_per_size = 15
max_samples = 20*unique_samples_per_size
samples_per_execution = 3 # This gives me the number of sequences in a set will be executed
executions_per_sample = 1 # This represents how many times the same set of sequences will be executed
...
seq_database_name = 'SeqDatabase-MaxSize_10000-Seq_5-SizeSample_15-Step_500-Samples_300-Execs_1'
seq_database_path = f"./sequences/{seq_database_name}-HighVariance.seq"
...
result_file_name = f'SeqResults-{seq_database_name}-threads_{threads}-Trim_{samples_per_execution}-HighVariance.hdf'
